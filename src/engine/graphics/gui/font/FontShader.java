...
{
    private static final String VERTEX_FILE = "src/engine/graphics/gui/font/fontVertexShader.glsl";
    private static final String FRAGMENT_FILE = "src/engine/graphics/gui/font/fontFragmentShader.glsl";

    private int location_transformationMatrix;
    private int location_offset;
    private int location_colour;
    private int location_background_colour;
    ...
    public void loadBackgroundColour(float r, float g, float b, float a)
    {
        super.loadVector4f(location_background_colour, new Vector4f(r, g, b, a));
    }
    ...
    protected void getAllUniformLocations()
    {
        ...
        location_background_colour = super.getUniformLocation("backgroundcolour");
